...
def visualise_embedding(loss_name: str, epoch: int, images: list, x_test: torch.Tensor, y_test: torch.Tensor, model: nn.Module):
    with torch.no_grad():
        model.eval()
    ...
    reducer = TSNE(n_components=2, perplexity=30., n_iter=3000, learning_rate='auto', init='pca', random_state=0)
